...
public class ProgressWheel extends RelativeLayout {
    ...
    private int rimColor = 0xFFFFFF00;
    ...
    public ProgressWheel(Context context, AttributeSet attrs) {
        ...
        mTextView.setTextColor(Color.parseColor("#eeeeee"));
    ...
    private void setupPaints() {
        barPaint.setColor(Color.parseColor("#eeeeee"));
        barPaint.setAntiAlias(true);
        barPaint.setStyle(Style.STROKE);
        barPaint.setStrokeWidth(barWidth);

        rimPaint.setColor(Color.parseColor("#FF097DEA"));
